...
int main(void)
{
    char green[] = /* VGA DATA */
        {
            12,   0,    6,    0,    0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x87, 0x08, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x97, 0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xFF, 0xF8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xF8,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x97, 0x48, 0x00, 0x00,
        };
    char white[] = /* Hercules data */
        {
...
void shot(int ufo_x, int ufo_y, int gd)
{
    ...
    for (sh_y = ufo_y - 1; sh_y > 0; sh_y -= 10) {
        setcolor(YELLOW);
        line(sh_x, sh_y - 10, sh_x, sh_y - 20);
        delay(30);
        setcolor(BLACK);
        line(sh_x, sh_y, sh_x, sh_y - 10);
    }
}
